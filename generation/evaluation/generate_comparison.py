...
for d in datasets:
    if d == 'average':
        continue
    truth_file = f'results/sar_llama/llama3_{d}_true_srl.json'
    for method in ['senna', 'xia']:
        preds_file = f'related_works/{method}/{d}_{method}_pred_srl.json'
    ...
    our_preds_file = f'results/sar_llama/llama3_{d}_pred_srl.json'
