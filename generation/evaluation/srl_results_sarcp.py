...
@click.option('--calculate_component_f1', default=False, show_default=True)
def main(mode, calculate_component_f1 = True):
    
    ground_truth = f'results/sarcp/phi_{mode}_true_srl.json'
    predictions = f'results/sarcp/phi_{mode}_pred_srl.json'
